...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    # -- core --
     user.username_attribute_names = [:login, :email]                                     # specify username
    ...
    # user.reset_password_email_sent_at_attribute_name = :reset_password_email_sent_at          # when was email sent,
     ...
     user.reset_password_mailer = ResetPasswordMailer                                                          # mailer class. Needed.

    # user.reset_password_email_method_name = :reset_password_email                             # reset password email
                                                                                                # method on your mailer
                                                                                                # class.

    user.reset_password_expiration_period = 1800                                               # how many seconds
                                                                                                # before the reset
                                                                                                # request expires. nil
                                                                                                # for never expires.
